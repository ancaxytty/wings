...
replaceitem entity @s slot.hotbar 2 da:float_on 1 0 {"item_lock":{"mode":"lock_in_slot"},"keep_on_death":{}}
replaceitem entity @s slot.hotbar 3 da:float_off 1 0 {"item_lock":{"mode":"lock_in_slot"},"keep_on_death":{}}
...
title @s[tag=menu_edit4] actionbar §l§7[§fMenu Particle edit §7] §8| §720 part. · 6 vel. · flotar
